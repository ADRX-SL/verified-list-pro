...
const examples = [
  "Heads of Sales at SaaS companies in New York, 50 to 200 employees",
    ...
    <section className="relative overflow-hidden pt-20 pb-20 md:pt-28 md:pb-28">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mt-8 text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          Describe your ideal customer and get ready-to-use lead lists with verified work emails and mobile numbers.
        </p>
        ...
        <div className="mt-12 mx-auto max-w-2xl">
          <div className="rounded-3xl border border-border bg-card p-4 sm:p-5 shadow-sm text-left">
            <textarea
              ...
              rows={3}
              placeholder="Heads of Growth at fintech companies in the US with over 200 employees"
